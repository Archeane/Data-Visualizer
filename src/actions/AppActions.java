...
public final class AppActions implements ActionComponent {
    ...
    public void handleSaveRequest() {
        ...
        try {
            if (dataFilePath == null) {
                ...
                File selected = fileChooser.showSaveDialog(((AppUI)(applicationTemplate.getUIComponent())).getPrimaryWindow());
                if (selected != null) {
    ...
    public void handleLoadRequest() {
        ...
        fileChooser.getExtensionFilters().add(extFilter);
        File selected = fileChooser.showOpenDialog(((AppUI)(applicationTemplate.getUIComponent())).getPrimaryWindow());
        if (selected != null) {
            dataFilePath = selected.toPath();
            AppData appData = new AppData(applicationTemplate);
            applicationTemplate.getUIComponent().clear();
